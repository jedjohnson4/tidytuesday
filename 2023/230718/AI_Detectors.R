...
df %>% 
  ...
  labs(title = "Detecting AI Generated Content",
       subtitle = "As GPT models become more advanced, can GPT detection models keep up? Plotted below is the ability<br>of various GPT detectors to determine the source of various texts produced by either GPT3, GPT4, or<br>humans. For GPT3 texts, the prompts 'plain' (85%) and 'elevate using literary' (15%) were used. For<br>GPT4 texts, the prompts 'elevate using technical' (61%) and 'enhance like native' (39%) were given.",
